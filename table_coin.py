...
class Window(QWidget):
    def __init__(self, parent=None):
        ...
        self.ch_mt_3 = QCheckBox('3분')
        self.ch_mt_5 = QCheckBox('5분')
...
class Chart(QWidget):
    ...
    # def __init__(self):
        ...
        p1_1.plot(x=xValue, y=df['ma5'], pen=(128, 65,217),name='ma5')
        # p1_1.plot(x=xValue, y=df['이평300마지' ], pen=g_dot,name='이평300마지')
        p1_1.plot(x=xValue, y=df['ma60'], pen=(120, 50, 50),name='ma60')
        ...
        p1_1.plot(x=xValue, y=df['ma20'], pen=(200, 50, 50),name='ma20')
        ...
        p1_1.plot(x=xValue, y=df['low'], pen=w_dot,name='close')

        p1_1.plot(x=buy_index, y=buy_price,   pen =None, symbolBrush =(  0,  0, 200),symbolPen ='w', symbol='t1' , symbolSize=10, name="진입") #마커
        p1_1.plot(x=sell_index, y=sell_price, pen =None, symbolBrush =(200,  0,  0),symbolPen ='w', symbol='t', symbolSize=10, name="청산") #마커
        # lr = pg.LinearRegionItem([50, 100])
        # lr.setZValue(-1)
        # p1_1.addItem(lr)

        p1_2.plot(x=xValue, y=df['고저평균대비등락율'],pen=(200, 50, 50),brush=(50,50,200,50),name='고저평균대비등락율')
        ...
        p1_3.plot(x=xValue, y=df['최고등락'], pen=(152, 20, 20),fillLevel=int(edit7), brush=(50,50,200,50),name='최고등락')
        p1_3.plot(x=xValue, y=df['최고등락평균'], pen=g_dot,name='최고등락평균')
        p1_3.plot(x=xValue, y=df['등락'], pen=y_dot,name='등락')
        p1_3.plot(x=xValue, y=df['등락평균'], pen=y_dot,name='등락평균')

        p1_4.plot(x=xValue,y=df['거래대금차'], pen='c',fillLevel=int(edit3), brush=(50,50,200,50),name='거래대금차')
        ...
        p1_5.plot(x=xValue, y=df['거래대금평균최고'], pen=y_dot,name='거래대금평균최고')
        p1_5.plot(x=xValue, y=df['거래대금평균최고마지'], pen=g_dot,name='거래대금평균최고마지')
        p1_5.plot(x=xValue, y=df['초대금평균차초대금평균최고'],     pen=(120,200,200),name='초대금평균차초대금평균최고')
        # p1_5.plot(x=xValue, y=df['초당거래대금변동평균' ],pen=(128, 65,217),name='초당거래대금변동평균')


        p1_6.plot(x=xValue, y=df['거래대금평균60' ],  pen=(120,200,200), name='거래대금평균60')
        ...
        p1_9.plot(x=xValue, y=df['volume'], pen=(200, 50, 50),name='volume')
        ...
        p1_11.plot(x=xValue, y=df['hei_open'], pen=(152, 20, 20),name='hei_open')
        p1_11.plot(x=xValue, y=df['hei_close'], pen=(20, 50, 150),name='hei_close')
        ...
        p2_1.plot(x=xValue, y=df['ma5'], pen=(120,200,200),name='ma5')
        p2_1.plot(x=xValue, y=df['ma20' ], pen=(250,150,150),name='ma20')
        ...
        p2_2.plot(x=xValue, y=df['거래대금변동평균'], pen=(200, 50, 50),brush=(50, 50, 200, 50), name='거래대금변동평균')
        p2_2.plot(x=xValue, y=df['거래대금변동평균최고'], pen=(204, 114, 61), name='거래대금변동평균최고')
    ...
    # p2_3.plot(x=xValue, y=df['체강차체강평균최저'], pen=g_dot, name='체강-체강평균(최저)')
        ...
        p2_4.plot(x=xDate, y=df['cci'], pen='c', fillLevel=int(edit3), brush=(50, 50, 200, 50), name='cci')
